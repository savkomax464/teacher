...
СПЕЦИАЛЬНЫЕ ПРАВИЛА ДЛЯ ЯЗЫКОВ:
Если "${subject}" - это иностранный язык (английский, испанский, французский и т.д.):
- Названия уроков пиши на РУССКОМ языке
- В описании добавляй ПРИМЕРЫ на изучаемом языке
- Формат: "Название темы: Описание на русском. Примеры: 'example 1', 'example 2'"
...
Для иностранного языка (английский):
1. Present Simple: Изучить правила образования. Примеры: 'I work', 'She likes coffee', 'They play football'.
Для математики:
...
СПЕЦИАЛЬНЫЕ ПРАВИЛА ДЛЯ ЯЗЫКОВ:
Если "${subject}" - это иностранный язык (английский, испанский, французский и т.д.):
- Теория пиши на РУССКОМ языке (объяснения, правила)
- Практика должна содержать МНОГО примеров на изучаемом языке
- Формат практики: "Составить предложения: 'example 1', 'example 2', 'example 3'"
...
Для иностранного языка (английский):
1. Present Simple: Изучение правил образования и случаев употребления. Практика: Составить предложения: 'I work every day', 'She likes coffee', 'They play football on weekends'.
Для математики:
...
СПЕЦИАЛЬНЫЕ ПРАВИЛА ДЛЯ ЯЗЫКОВ:
Если "${subject}" - это иностранный язык (английский, испанский, французский и т.д.):
- Объяснения и правила пиши на РУССКОМ языке
- Примеры давай ОБЯЗАТЕЛЬНО на изучаемом языке с переводом
- Используй МНОГО примеров предложений на изучаемом языке (минимум 5-7 примеров)
- Формат примера: "I work every day (Я работаю каждый день)"
- В разделе "Подводные камни" указывай типичные ошибки русскоговорящих
...
4. СТРОГАЯ СТРУКТУРА КОНСПЕКТА:
   ...
   - Пример: Самый наглядный практический пример СТРОГО ПО ТЕМЕ "${subject}". ДЛЯ ЯЗЫКОВ: минимум 5-7 примеров предложений на изучаемом языке.
