...
const LessonDetail: React.FC<LessonDetailProps> = ({
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Процент прокрутки: сколько контента пользователь увидел
    ...
    >
      ...
      <div ref={scrollRef} style={styles.scrollContent}>
        ...
        >
          ...
          <h3 style={styles.sectionTitle}>Суть</h3>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {lesson.example.code && (
              <motion.div
                whileHover={!isMobile ? { boxShadow: '0 0 40px rgba(255, 214, 10, 0.08)' } : {}}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {lesson.pitfalls.map((pitfall, i) => (
              <motion.div
                ...
                whileHover={!isMobile ? { translateX: '4px', borderColor: 'var(--color-border-light)' } : {}}
                style={styles.pitfallCard}
              >
